  ...
  return <div>
    ...
    <div className="split" style={{marginTop:18}}>
      <section className="card">
        ...
        <div className="question" style={{marginTop:18}}>{q.question}</div>{q.equation&&<div className="equation-preview" dangerouslySetInnerHTML={{__html:(()=>{try{return katex.renderToString(q.equation,{displayMode:true,throwOnError:false})}catch{return q.equation}})()}}/>}
