...
export default function App(){
 ...
 const handleAnswer=async(q,aIndex,modeName="practice",durationSeconds=0,meta={})=>{
   ...
   // Do NOT block the answer UI while generating the next AI question.
   // The practice page starts generation after it has received the diagnosis,
   // so the student immediately sees whether the answer was correct.
   return {...d,recommendation:null,generatedQuestion:null,generationError:null};
 };
